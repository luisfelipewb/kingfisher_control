...
# set torch to print with 2 decimal points
...
class RLAgent:
    ...
    def __init__(self):
        ...
        self.init_goal_cos_sin = None
        self.init_goal_distance = None
    ...
    def get_observations(self):
        ...
        if self.init_goal_cos_sin is None:
            self.init_goal_cos_sin = goal_cos_sin
        ...
        rospy.loginfo_throttle(1, f"obs_buffer[0,10] : {self._obs_buffer[0,10]}")
